...
- name: Google Container Engine API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-container-engine/master/_listings/google-container-engine/v1-projects-projectid-zones-zone-serverconfig-get.md
x-common:
- type: x-change-log
